    ...
    <>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          I’m Pabo Bernando, a software designer and engineer based in Yogyakarta City. I’m the part of Kewr
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://twitter.com/pabobernando"
              aria-label="Follow on Twitter"
              icon={TwitterIcon}
            />
            <SocialLink
              href="https://www.instagram.com/pabobernando/"
              aria-label="Follow on Instagram"
              icon={InstagramIcon}
            />
            <SocialLink
              href="https://github.com/pabobernando"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/pabo-bernando-14a162215/"
