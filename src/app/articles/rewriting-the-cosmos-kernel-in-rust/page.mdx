...
export const article = {
  ...
  description: 'PWA stands for Progressive Web App. A PWA is a web app that is designed to provide a better and more app-like experience. PWAs can be installed on users devices, run in the background, and receive push notifications. ',
}
