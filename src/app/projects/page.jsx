...
export const metadata = {
  title: 'Projects',
  description: 'Open-Source Projects for Everyone.',
}

export default function Projects() {
  return (
    <SimpleLayout
      title="Open-Source Projects for Everyone."
      intro="I've worked on many small projects over the past 3 years, but these are the ones I'm most proud of. Many of them are open-source, so if you see something that interests you, check out the code or contribute in other ways, such as by designing a logo or icon, or by translating the text into another language."
    >
      <ul
        role="list"
